...
class Review(models.Model):
    ...
    The rating fields are integers set in range from 1 to 5. This is rendered on
    the review as stars.

    The __str__ method returns a string representation of the review, including the 
    username of the reviewer and their overall rating.
    """
