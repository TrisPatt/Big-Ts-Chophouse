...
def reservation_create(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Calculate how many tables of 2 are needed
...
def update_reservation(request, reservation_number):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Check for table availability at the updated date and time,
            # excluding current reservation
            ...
            if tables_needed <= available_tables:
                # Clear existing tables and assign new ones
                # based on updated details
